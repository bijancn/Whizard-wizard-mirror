...
Title=$\quad e^+e^-\to W^+b W^-\bar{b}$, $N_\text{jets}\geq 2, \quad \quad \sqrt{s} = 342 \text{GeV}$
 END PLOT
...
XLabel=$\Delta \phi^{W^+ j_b}$
 END PLOT

 BEGIN PLOT /WHIZARD_.*/Phi\(b\,b\)
XLabel=$\Delta \phi^{j_b j_{\bar{b}}}$
 END PLOT
...
YLabel=$\frac{d\sigma}{d\Delta R}[\text{fb}]$
XLabel=$\Delta R^{W^- j_{\bar{b}}}$
LegendXPos=0.10
 END PLOT

 BEGIN PLOT /WHIZARD_.*/R\(b\,Wp\)
YLabel=$\frac{d\sigma}{d\Delta R}[\text{fb}]$
XLabel=$\Delta R^{W^+ j_b}$
LegendXPos=0.10
 END PLOT

 BEGIN PLOT /WHIZARD_.*/R\(b\,b\)
YLabel=$\frac{d\sigma}{d\Delta R}[\text{fb}]$
XLabel=$\Delta R^{j_b j_{\bar{b}}}$
LegendXPos=0.10
 END PLOT
