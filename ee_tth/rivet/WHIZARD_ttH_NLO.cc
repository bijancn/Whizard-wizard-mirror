...
#include "NLOHisto1D.cc"
  ...
  public:
    ...
    void init() {
      ...
      _h["leadingjet_E"] = bookNLOHisto1D("leading-jet-E", stdbin, 250., 400.);
      ...
      _h["2ndleadingjet_E"] = bookNLOHisto1D("2nd-leading-jet-E", stdbin, 0., 350.);
      ...
      _h["jets_invMass"] = bookNLOHisto1D("jets-inv", stdbin, 0., 650.);
